...
public class EntityAdapterBase implements EntityAdapter {
    ...
    EntityAdapterBase(String OBF_addAdditionalSaveData, String OBF_readAdditionalSaveData, String OBF_type, String OBF_getDescriptionId, String OBF_getAsString, String OBF_parseTag) throws NoSuchMethodException, SecurityException, ClassNotFoundException, UnknownServerVersionException, NoSuchFieldException {
        super();
